...
\begin{document}
	\begin{frame}
		\titlepage
		\phantom{\cite{Mink04}\cite{Gurry17}\cite{WG17}\cite{Edmondson19}\cite{EdmondsonCBGM}\cite{PerathonerCBGM}\cite{McCollumCBGM}}%Hide initial full-text citations here
	\end{frame}
